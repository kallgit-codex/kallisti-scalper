...
export const config = {
  ...
  strategy: {
    ...
    targetProfitPercent: 0.12, // Increased from 0.10 to 0.12 for better profit
    
    // Stop losses - TIGHT
    initialStopPercent: 0.20,  // Reduced from 0.35 to 0.30 for tighter stops
    recoveryStopPercent: 0.22, // Wider for recovery
    
    // Time limits - FAST
    maxTradeSeconds: 180,      // Reduced from 300 to 240 for faster exits
    quickExitSeconds: 90,      // Reduced from 120 to 90 for quicker breakeven exits
    ...
    // Volume confirmation
    volumeMultiplier: 1.8,     // Increased from 1.5 to 1.8 for better volume confirmation
    volumeLookback: 20,
  ...
  risk: {
    ...
    maxTradesPerHour: 12,      // Reduced from 30 to 20 for better quality trades
